...
def get_args():
    ...
    parser.add_argument("--epsilon", type=float, default=0.07, help="epsilon greedy")
    parser.add_argument("--noise_rate", type=float, default=0.05, help="noise rate for sampling from a standard normal distribution ")
